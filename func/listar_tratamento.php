...
$lista = $conn->query("select * from tratamento where id_func = '".$_SESSION['Id']."';");
...
<head> 
    ...
    <title>Listar Tratamentos</title>
</head>
...
<br><br><br>
<h1 style="margin-left: 750px; color: #1d5f96;">Tratamentos</h1>

    <div style="display: flex;">
        <div class="border-bottom border-2 border-dark" style="width: 83%; margin-left: 300px;"></div>
    </div>
    <br>
<a href="tratamento.php" target="_self" class="btn btn-block btn-xs" style="background-color: #38B6FF; margin-left: 300px;" role="button">
    <ion-icon name="add-circle-outline"></ion-icon>
    <span class="hidden-xs">ADICIONAR NOVO TRATAMENTO</span>
</a>
<br><br><br>
    ...
    <table class="table table-hover table-borderless container w-100" style=" margin-top: 15px;">
        <thead>
            <tr style="background-color: #38B6FF;" class="text-center">
                <th scope="row" style="color: #fff;">Anotação</th>
                <th scope="col" style="color: #fff;">Acompanhamento</th>
                <th scope="col" style="color: #fff;">Medicamento</th>
                <th scope="col" style="color: #fff;">Finalização</th>
        ...
        <?php if($lista){
            ...
            <tr class="text-center">
                <th scope="row"><?php echo $row['anotacao_func'];?></th>
                <td><?php echo $row['acompanhamento'];?></td>
                <td><?php echo $row['medicamento_usado'];?></td>
                <td><?php echo $row['finalizacao'];?></td>
                <td><?php echo $rowPac['nome'];?></td>
                <td>
                <!-- botão alterar -->
                    <a href="editar_tratamento.php?id=<?php echo $row['id'];?>" role="button" class="btn btn-block btn-xs" style="background-color: #66CDAA;"> 
...
<br>
<!-- Modal de tratamento adicionada -->
<div class="modal fade" id="modal_tratamento" tabindex="-1" role="dialog" aria-labelledby="modal_cadastro_centro" aria-hidden="true">
                    ...
                    <div class="modal-body">
                            <p class="text-center">Tratamento adicionada com sucesso!</p>        
...
<?php if(isset($_GET['trat']) && ($_GET['trat'] == "s")){?>
                    <script>
