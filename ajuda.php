...
<h1 style=" display:flex; justify-content: center; color:white; margin-top:4%;">Como podemos ajudar ?</h1>
<br><br><br>
<!-- Primeiro Dropdown-->
<div class="accordion" id="accordionExample">
  <div class="accordion-item" style="border: 0;">
    <h2 class="accordion-header">
    <button class="accordion-button btn-orange" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" >
